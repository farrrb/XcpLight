...
#ifndef XCPLIGHT_INTERNALS_H__
#define XCPLIGHT_INTERNALS_H__
...
//* PROTECTION STATUS *
#define XCP_PRT_PROTECT_NONE            (0x00u)
...
typedef struct XcpLightInternals
{
  ...
  XcpLightMessage_t cto_cmd_msg;
#endif
  XcpLightMessage_t cto_reply_msg;
  void     *mta;
  ...
  uint8_t   unlock_resource;
  uint8_t   seed[XCPLIGHT_CFG_SEED_LENGTH];
  uint8_t   seed_index;
  uint8_t   remaining_seed_bytes;
